...
// Source: ../../Personal/portfolio/src/app/(pages)/blog/[slug]/page.tsx
// Variable: BLOG_QUERY
// Query: *[    _type == "blog" &&    slug.current == $slug  ][0]{  ...,  "date": coalesce(date, now()),}
...
// Query: *[  _type == "blog" && defined(slug.current)]{  "slug": slug.current,  "lastModified": coalesce(_updatedAt, _createdAt, now())} | order(lastModified desc)
